...
export const BIG = [
  { id: 'amazon', q: 'Was the Amazon a wilderness before 1492?',
    ev: [{ p: 'prumers2022-conclusions-p1', q: 'Our results put to rest arguments that western Amazonia was sparsely populated in pre-Hispanic times.' },
      { p: 'prumers2022-conclusions-p1', q: 'We propose that the Casarabe-culture settlement system is a singular form of tropical agrarian low-density urbanism' }] },
];
...
export default [
  ...
  {
    id: 'casarabe-made-landscape', kind: 'choice', big: 'amazon', lens: ['own-terms', 'against-progress'],
  ...
  {
    id: 'order-hemisphere', kind: 'order', big: 'amazon', lens: ['own-terms'],
    prompt: 'Oldest first.',
    items: [
