...
export default [
  ...
  // ── Haiti in its own words (state papers, London 1816) ────────────────
  {
    id: 'leclerc-promise', kind: 'choice', big: 'revolutions', at: 1802, lens: ['record', 'contested'],
    prompt: 'France sent a fleet and an army to Saint-Domingue in 1802. Its proclamation told the population how to answer anyone who said the force had come to take their liberty. What was the answer it gave them?',
    answer: 'That the Republic had given them liberty',
    options: ['That the fleet carried only traders', 'That the army would leave by winter', 'That liberty was never promised'],
    must: ['It is the Republic that has given us liberty'],
    ev: [{ p: 'haytian1816-p53', q: 'Should any one whisper in your ear, " These forces are destined to despoil you of your liberty ;" answer, " It is the Republic that has given us liberty ; the Republic mill never suffer it to be ravished from us."' },
      { p: 'wh2-7.3-p45', q: 'Napoléon attempted to reinstate slavery and reclaim French control of Saint-Domingue in 1802' }],
  },
  {
    id: 'christophe-proof', kind: 'choice', big: 'revolutions', at: 1802, lens: ['own-terms', 'record'],
    prompt: 'A Haitian general wrote to the French commander in 1802 saying what would make him submit. What did he demand first?',
    answer: 'The laws guaranteeing liberty, in writing',
    options: ['A command in the French army', 'The withdrawal of the fleet', 'Payment for his soldiers'],
    must: ['on obtaining this desired proof, by being made acquainted with these laws, 1 shall submit immediately'],
    ev: [{ p: 'haytian1816-p76', q: 'The laws which consecrate the principles, and which the mother country, without doubt, has enacted, will carry to my heart this conviction; and I protest, that on obtaining this desired proof, by being made acquainted with these laws, 1 shall submit immediately.' },
      { p: 'wh2-7.3-p45', q: 'Napoléon attempted to reinstate slavery and reclaim French control of Saint-Domingue in 1802' }],
  },
  {
    id: 'leclerc-no-code', kind: 'choice', big: 'revolutions', at: 1802, lens: ['against-progress', 'record'],
    prompt: 'The French commander replied to that demand for the law guaranteeing freedom. What did he have to admit?',
    answer: 'The code did not yet exist',
    options: ['That it had been repealed', 'That it was secret', 'That it applied only to soldiers'],
    must: ['You demand of me the code which gives assurance of liberty to the Negroes ; that code is not completed'],
    ev: [{ p: 'haytian1816-p84', q: 'You demand of me the code which gives assurance of liberty to the Negroes ; that code is not completed : I am engaged upon it at this moment.' }],
  },
  {
    id: 'hayti-dating', kind: 'choice', big: 'revolutions', at: 1810, depth: 'detail', lens: ['own-terms', 'record'],
    prompt: 'A decree issued from the palace at Cape Henry on 8 October 1810 carries a second date beside the first. What did the Haitian state count its years from?',
    answer: 'Its own independence',
    options: ['The French Revolution', 'The king’s accession', 'The end of the slave trade'],
    must: ['in the seventh year of the independence of Hayti'],
    ev: [{ p: 'haytian1816-p281', q: 'Done at our Palace of Cape Henry, the 8th October 1810, in the seventh year of the independence of Hayti.' }],
  },
  {
