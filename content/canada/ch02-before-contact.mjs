...
export default [
  // ── records ────────────────────────────────────────────────────────────
  {
    id: 'grease-trails', kind: 'choice', lens: ['record', 'economy'],
  ...
  {
    id: 'trail-markers', kind: 'choice', lens: ['record', 'own-terms'],
  ...
  {
    id: 'birchbark-scrolls', kind: 'choice', lens: ['record', 'against-progress'],
  ...
  {
    id: 'midewiwin', kind: 'choice', lens: ['record'],
  ...
  {
    id: 'giant-beaver', kind: 'choice', lens: ['record', 'against-progress'],
  ...
  {
    id: 'wickwire-fraser', kind: 'choice', lens: ['record'],
  ...
  {
    id: 'innis-speech', kind: 'choice', lens: ['record'],
  ...
  {
    id: 'written-record-ignored', kind: 'choice', lens: ['against-progress', 'record'],
    prompt: 'Why is it “generally, and wrongly” believed that the Americas had no historic record?',
  ...
  },
  {
    ...
    options: ['A small Norse contribution in the northeast', 'A Welsh line in the Ohio Valley', 'It is split evenly, and still debated'],
  ...
  {
    id: 'maritime-archaic-currency', kind: 'choice', lens: ['economy', 'own-terms'],
  ...
  {
    id: 'three-sisters', kind: 'choice', lens: ['own-terms'],
    prompt: 'Why do the “three sisters” — corn, beans and squash — grow better together?',
    answer: 'Corn is a pole for the beans, squash leaves hold moisture, beans put back nitrogen',
    options: ['Each keeps away the insects that eat the others', 'They ripen at different times, spreading the harvest', 'Squash roots break up the soil for the corn'],
    must: ['pole', 'retained moisture', 'nitrogen'],
  ...
  {
    id: 'tenochtitlan', kind: 'choice', lens: ['own-terms', 'against-progress'],
  ...
  },
  {
    ...
    answer: 'Marking where the sun rose at solstices and equinoxes: a community calendar',
    options: ['Drying hides and meat in the sun', 'Displaying the heads of defeated enemies', 'Fencing the chief’s household off from the plaza'],
  ...
  {
    id: 'cahokia-rivers', kind: 'choice', lens: ['economy'],
    prompt: 'Why did Cahokia become a centre of power?',
    answer: 'It sat near where three rivers meet, so it controlled regional trade',
  ...
  {
    id: 'mississippian-uncle', kind: 'choice', lens: ['own-terms'],
  ...
  {
    id: 'keatley-creek', kind: 'choice', lens: ['own-terms', 'against-progress'],
    ...
    answer: 'It was dense and settled, and built on salmon rather than farming',
  ...
  {
    id: 'head-smashed-in', kind: 'choice', lens: ['own-terms'],
    ...
    options: ['About 570 years ago', 'About 1,500 years ago', 'About 12,000 years ago'],
  ...
  },
  {
    ...
    options: ['Killing the enemy’s war leader', 'Capturing the enemy’s horses', 'Taking a scalp'],
  ...
  {
    id: 'confederacies-feuds', kind: 'choice', lens: ['own-terms'],
  ...
  {
    id: 'wampum-record', kind: 'choice', lens: ['economy', 'record'],
    ...
    options: ['Rank badges showing a person’s clan', 'Tokens of mourning for the dead', 'Decoration with no further meaning'],
  ...
  {
    id: 'potlatch-witness', kind: 'choice', lens: ['economy', 'own-terms'],
    prompt: 'At a potlatch the host gave property away. What did a guest take on by accepting it?',
    answer: 'The duty to witness that the event being marked was legitimate',
  ...
  {
    id: 'everyone-traded', kind: 'choice', lens: ['economy', 'against-progress'],
  ...
  {
    id: 'made-landscapes', kind: 'choice', lens: ['against-progress', 'own-terms'],
    ...
    answer: 'Human-made: kept open by centuries of controlled burning and horticulture',
    options: ['Natural meadows left by retreating glaciers', 'Burned-over ground from lightning fires', 'Abandoned village sites grown over'],
  ...
  {
    id: 'how-people-came', kind: 'choice', lens: ['contested'],
